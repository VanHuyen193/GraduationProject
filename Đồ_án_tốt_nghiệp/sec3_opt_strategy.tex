...
tới bốn thuật toán mà đề tài đem ra so sánh. Phần cuối chương dành cho Unity ML-Agents,
...
\indent Bảng~\ref{tab:rl_comparison} tóm tắt vị trí của bốn thuật toán được sử dụng
...
\indent Bốn thuật toán vừa trình bày không xếp được thành một thang bậc từ yếu đến
mạnh. Chúng phân hóa theo ba trục độc lập: cách lấy dữ liệu (on-policy hay off-policy),
cách xử lý nhiều tác nhân (không có, attention hay chia sẻ tham số) và chi phí tính toán
của mỗi bước cập nhật. Chính ba trục này, chứ không phải một thứ hạng chung, quyết định
...
cơ chế attention của MA-POCA mới thực sự cần thiết. Chương~\ref{ch:results} kiểm chứng
từng khuyến nghị này bằng số liệu thực đo.
...
với đề tài. Cơ chế self-play - vốn cần thiết cho môi trường đối
...
quá trình self-play. Cơ chế group reward phục vụ bài toán hợp tác cũng
được thiết kế tối ưu cho POCA; khi áp dụng cho PPO hoặc SAC, phần thưởng nhóm buộc
phải được phân bổ thủ công về từng agent, làm suy giảm khả năng gán công lao. Ngoài ra,
