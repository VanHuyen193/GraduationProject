...
vẹn quá trình thiết kế không gian quan sát, không gian hành động và hàm phần thưởng - kể
cả những phương án đã thử rồi phải bỏ.
...
đúng cái trạng thái phối hợp mà nhiệm vụ đòi hỏi - hai tác nhân đứng tách nhau ở hai phía
...
ta ngồi xem hành vi thật. Bài học rút ra - phải kiểm tra xem hàm phần thưởng có vô tình
phạt chính hành vi đích hay không - áp dụng được cho bất kỳ môi trường hợp tác nào, chẳng
riêng gì môi trường này.

\indent Ba môi trường đã được đóng thành một gói Unity Package Manager, kèm mười lăm tệp
cấu hình huấn luyện, bộ công cụ Editor và trình hướng dẫn cài đặt bảy bước. Nhờ vậy chúng
tồn tại như một sản phẩm dùng lại được, chứ không chỉ là mã nguồn của một đồ án. Đề tài
cũng bổ sung vào ML-Agents hai thuật toán vốn không có sẵn - MAPPO và DQN - dưới dạng
trainer mở rộng, đồng thời hiện thực hóa quy trình nối môi trường Unity với một thư viện
học tăng cường bên ngoài qua Python Low-Level API.

\indent Mười lăm lần huấn luyện đã xác nhận cả ba môi trường đạt yêu cầu theo ba tiêu chí
...
trong khi SAC sụp đổ ở $0{,}183$ - và thứ hạng ở cả hai nơi đều giải thích được bằng cơ
chế của bài toán. Chúng cũng \textit{không có lối tắt}: không lần chạy nào đạt phần thưởng
...
toán ghép được với tự chơi đều tăng ELO từ ba mươi sáu tới sáu mươi bốn điểm so với phiên
bản cũ của chính mình - cơ chế tự chơi hoạt động đúng. Nhưng biên độ ấy quá hẹp để môi
...
Nói cách khác, đặc tính bài toán - thứ do thiết kế môi trường quyết định - chi phối kết
quả mạnh hơn lựa chọn thuật toán. Và đó chính là lý do khâu xây dựng môi trường đáng được
đầu tư nhiều hơn mức thường thấy.

\indent Bên cạnh phần thực nghiệm so sánh, đề tài còn dựng hoàn chỉnh một ứng dụng trình
diễn tương tác, trong đó cả mười lăm mô hình đã huấn luyện được triển khai thẳng vào game
dưới định dạng ONNX. Người dùng ở đó chọn môi trường, chọn một trong ba chế độ chơi - tự
điều khiển, tác nhân tự chơi, chơi cùng tác nhân - chọn mô hình cụ thể cho tác nhân, và
...
Package Manager cài được vào dự án bất kỳ, kèm mười lăm cấu hình huấn luyện đã chạy thật,
...
các quyết định vận hành ảnh hưởng lớn nhưng ít được bàn - nhân khu vực huấn luyện để tăng
thông lượng, dựng biến thể không gian hành động rời rạc cho thuật toán dựa trên giá trị -
và hai con đường đưa một thuật toán không có sẵn vào Unity: gói trainer mở rộng đăng ký
...
cho phép đặt cạnh nhau cả mười lăm chính sách đã huấn luyện, và hai tab số liệu huấn luyện
...
\subsection{Hạn chế}
\label{sub:limits}
\indent Hạn chế nặng nhất của đề tài: mỗi tổ hợp môi trường - thuật toán chỉ chạy với đúng
một seed. Nghĩa là mọi chênh lệch báo cáo ở Chương~\ref{ch:results} đều chưa tách được
phần do bản chất thuật toán khỏi phần do may rủi của một lần khởi tạo. Những khoảng cách
lớn - DQN xếp cuối trên Cross The Road, SAC sụp đổ trên Capture The Flag - nhiều khả năng
vẫn đứng vững; nhưng các thứ hạng sát nhau thì đừng đọc như một kết luận thống kê. Đây là
...
\indent Việc phải làm trước tiên là chạy lại toàn bộ mười lăm tổ hợp với nhiều hạt giống,
...
\indent Ở tầm xa hơn, bộ so sánh có thể mở rộng bằng những thuật toán như DreamerV3 hay
QMIX - việc bổ sung giờ đã rẻ hơn nhiều nhờ cơ chế trainer mở rộng đã dựng sẵn - còn ba
môi trường thì có thể nâng độ phức tạp lên gần với game thương mại. Riêng ứng dụng trình
