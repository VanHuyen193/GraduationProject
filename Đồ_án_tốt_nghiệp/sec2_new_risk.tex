...
MA-POCA và MAPPO trên từng loại môi trường. Đích đến của đề tài không phải là tìm ra
...
\begin{itemize}
    ...
    \item \textbf{Huấn luyện và thu thập số liệu.} Đề tài triển khai huấn luyện bốn thuật
    toán PPO, SAC, MA-POCA và MAPPO trên từng môi trường trong cùng điều kiện phần cứng,
    đồng thời thu thập và phân tích kết quả theo bốn tiêu chí định lượng là tốc độ hội
    tụ, tỷ lệ hoàn thành nhiệm vụ, tổng phần thưởng trung bình và độ ổn định của quá
    trình huấn luyện.
...
The Road. Nhóm thuật toán bao gồm bốn thuật toán học tăng cường được khảo sát, gồm PPO
(thuật toán tối ưu chính sách vùng lân cận), SAC (thuật toán actor-critic cực đại hóa
entropy), MA-POCA (thuật toán gán công lao cho đa tác nhân) và MAPPO (mở rộng PPO cho
đa tác nhân với chia sẻ tham số). Nhóm công cụ bao gồm bản thân nền tảng Unity ML-Agents
cùng giao diện lập trình cấp thấp bằng Python phục vụ việc tích hợp thuật toán tùy chỉnh.
...
việc đặt PPO, SAC, MA-POCA và MAPPO lên cùng một bàn cân gần như không thực hiện được
