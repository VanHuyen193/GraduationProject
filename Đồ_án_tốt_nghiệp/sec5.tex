...
lẫn DQN, vì một lý do có tính quyết định đối với mục tiêu so sánh: chỉ khi cả năm thuật
toán chạy trên cùng một đường ống thu thập quỹ đạo, cùng một cách ghi nhật ký và cùng
một định dạng mô hình xuất ra, thì chênh lệch đo được giữa chúng mới quy được cho bản
thân thuật toán chứ không cho sự khác biệt của hạ tầng đo.
