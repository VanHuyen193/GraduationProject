...
\indent Đây là chương trọng tâm của đồ án. Nếu phần khó nhất của một dự án học tăng
cường nằm ở khâu xây dựng môi trường - như đã lập luận ở Mục~\ref{ch:intro} - thì
chương này chính là nơi trình bày phần khó đó: quá trình biến ba ý tưởng trò chơi thành
ba đặc tả mà tác nhân học được.

\indent Trọng tâm được đặt vào \textit{lý do} của từng quyết định thiết kế chứ không
chỉ vào kết quả cuối cùng. Với mỗi môi trường, chương trình bày đại lượng nào được đưa
vào quan sát và vì sao đại lượng khác bị loại, phần thưởng được chia thành những thành
phần nào và mỗi thành phần chống lại hành vi sai lệch cụ thể nào, cùng những đặc tả đã
thử rồi phải bỏ. Phần cuối cùng này quan trọng không kém phần thành công: một hàm phần
thưởng hỏng không làm chương trình báo lỗi, nó chỉ khiến tác nhân học sai, nên biết
được dấu hiệu nhận ra nó có giá trị thực dụng cao hơn là chép lại một cấu hình đã chạy
được.

\indent Bố cục chương như sau. Phần đầu dành cho những gì áp dụng chung cho cả ba môi
trường: kiến trúc huấn luyện, cách chọn quan sát và hành động, và bốn nguyên tắc thiết
kế hàm phần thưởng mà mọi con số trong các bảng về sau đều phải giải thích được bằng
chúng. Ba mục kế tiếp đi vào từng môi trường một. Chương khép lại bằng lối đi vòng qua
Python Low-Level API - thứ mà đề tài buộc phải dùng đến vì trainer tích hợp sẵn không
đáp ứng được - rồi tới thiết lập thực nghiệm và tiêu chí đánh giá dùng để nghiệm thu ba
...
kinh nghiệm cùng lúc. Cả ba cảnh dùng cho các lần huấn luyện được báo cáo ở
Chương~\ref{ch:results} đều chứa tám khu vực chạy song song. Cách làm này tăng lượng
kinh nghiệm thu được trên mỗi bước mô phỏng và làm giảm tương quan giữa các mẫu trong
cùng một lô cập nhật, nhưng cũng có nghĩa là cùng một số bước môi trường ở đây không
tương đương với cùng số bước ở một cấu hình dùng một khu vực duy nhất - đây là chi tiết
cần lưu ý khi đối chiếu kết quả của đề tài với các công bố khác. Bên cạnh đó, hệ số
tăng tốc mô phỏng được đặt ở mức gấp hai mươi lần thời gian thực, cho phép
Unity mô phỏng nhanh hơn nhiều so với tốc độ hiển thị thông thường mà không ảnh hưởng
đến tính đúng đắn của vật lý. Toàn bộ mười lăm lần huấn luyện của đề tài được điều phối
tự động bằng một chương trình Python trình bày ở Mục~\ref{sub:codestruct}.
...
trên cùng một máy, mỗi môi trường lấy lần chạy PPO làm đại diện. Điều đáng chú ý là ba
con số nằm khá gần nhau, trong khoảng năm trăm sáu mươi lăm tới bảy trăm bước mỗi giây,
dù ba môi trường khác nhau rất xa về khối lượng vật lý. Nguyên nhân là hai yếu tố tác
động ngược chiều nhau và gần như triệt tiêu lẫn nhau: khối lượng vật lý phải mô phỏng
trong mỗi khu vực, và số bước vật lý giữa hai lần ra quyết định. Cross The Road chỉ mô
phỏng một khối tác nhân trượt theo ô lưới cùng năm chiếc xe chuyển động thẳng nên nhanh
nhất, dù mỗi quyết định của nó trải trên năm bước vật lý. Football Table phải giải các
khớp vật lý của tám thanh gạt cùng va chạm liên tục của quả bóng, nhưng bù lại chỉ cách
hai bước vật lý giữa hai quyết định. Capture The Flag có vật lý nhẹ nhất trong ba môi
trường lại chậm nhất, vì mỗi quyết định của tác nhân trải trên tới hai mươi bước vật lý
và mỗi lượt chơi kéo dài tối đa một trăm nghìn bước.

\indent Hệ quả thực tiễn của việc ba tốc độ gần nhau là thời gian huấn luyện của các
thuật toán on-policy trên cả ba môi trường đều rơi vào khoảng năm mươi phút cho một lần
chạy. Chênh lệch thời gian thực đáng kể mà Chương~\ref{ch:results} ghi nhận vì vậy đến
từ bản thân thuật toán, cụ thể là chi phí cập nhật mạng của nhóm off-policy, chứ không
đến từ môi trường.
...
hai trăm. Số bước huấn luyện được đặt ở một triệu sáu trăm nghìn bước, dùng chung cho cả
năm thuật toán trên môi trường này. Bốn thuật toán còn lại là SAC, MA-POCA, MAPPO và
DQN, huấn luyện dưới cùng điều kiện để bảo đảm mặt bằng so sánh công bằng; riêng DQN
không ghép được với cơ chế tự chơi và phải chạy trên một bản dựng có không gian hành
động rời rạc, như đã nêu ở Mục~\ref{sub:evalcriteria}. Cấu hình siêu tham số đầy đủ được
liệt kê trong các Phụ lục A đến D.
...
chính xác cho từng tác nhân. Đối chứng gần nhất của nó là MAPPO: cùng dùng phê
bình tập trung nhìn quan sát của cả nhóm, nhưng tính công lao theo cách khác. Ba thuật
toán còn lại là PPO, SAC và DQN, vốn không có cơ chế nào dành riêng cho phối hợp, đóng
vai trò mốc so sánh để trả lời câu hỏi phê bình tập trung có thực sự đáng giá hay không;
với chúng, phần thưởng nhóm được ML-Agents phân bổ về từng tác nhân. Cả năm
...
toán. Số bước huấn luyện được đặt ở một triệu bảy trăm nghìn bước cho cả năm thuật toán.
...
hợp để so sánh trực tiếp cả năm thuật toán trên cùng một bài toán trong điều kiện tương
đương; đây cũng là môi trường duy nhất trong đề tài mà cả năm thuật toán đều chạy được
mà không cần sửa đổi gì về phía Unity. Mạng nơ-ron sử dụng hai lớp ẩn với một trăm hai
mươi tám đơn vị mỗi lớp, một
kích thước vừa phải tương xứng với độ phức tạp của bài toán. Năm thuật toán PPO, SAC,
MA-POCA, MAPPO và DQN được cấu hình tương đương nhau nhất có thể về kích thước lô và
kiến trúc mạng nhằm bảo đảm sự khác biệt về kết quả phản ánh đúng bản chất thuật toán.
Cần lưu ý rằng vì đây là môi trường đơn tác nhân không có nhóm, ưu thế phê bình tập
trung của MAPPO và MA-POCA không có đối tượng để phát huy, nên trên môi trường này cả
hai được kỳ vọng suy biến về PPO; do đó Cross The Road chủ yếu đóng vai trò kiểm chứng
tính nhất quán của các thuật toán trên một bài toán điều hướng chuẩn. Số bước huấn
luyện tối đa được đặt ở hai triệu bước cho cả năm thuật toán.
...
\indent Như đã phân tích ở Mục~\ref{sub:mllimits}, ML-Agents 4.0.2 chỉ tích hợp sẵn ba
trainer là \texttt{ppo}, \texttt{poca} và \texttt{sac}. Hai thuật toán còn lại trong
lưới so sánh của đề tài, MAPPO và DQN, phải được đưa vào bằng tay. Có hai con đường
khả dĩ, và lựa chọn giữa chúng quyết định luôn chất lượng của phép so sánh về sau.

\indent Con đường thứ nhất là bỏ hẳn chương trình huấn luyện của ML-Agents, kết nối
với môi trường Unity qua giao diện lập trình cấp thấp và dùng một thư viện học tăng
cường bên ngoài. Con đường còn lại là giữ nguyên chương trình huấn luyện, chỉ bổ sung
thuật toán mới dưới dạng trainer mở rộng. Đề tài chọn con đường thứ hai cho cả MAPPO
lẫn DQN, vì một lý do có tính quyết định đối với mục tiêu kiểm chứng môi trường: chỉ khi
cả năm thuật toán chạy trên cùng một đường ống thu thập quỹ đạo, cùng một cách ghi nhật
ký và cùng một định dạng mô hình xuất ra, thì chênh lệch đo được giữa chúng mới phản ánh
đặc tính của môi trường chứ không phản ánh sự khác biệt của hạ tầng đo.

\subsubsection{Bổ sung thuật toán bằng cơ chế trainer mở rộng}
\label{sub:pyapi}
\indent ML-Agents cho phép đăng ký thêm trainer thông qua một điểm mở rộng theo tên:
mỗi trainer mới khai báo một mục trong danh sách \texttt{ML\_AGENTS\_TRAINER\_TYPE},
gắn một chuỗi định danh với hàm khởi tạo tương ứng. Sau khi gói mở rộng được cài đặt,
chương trình \texttt{mlagents-learn} nhận ra giá trị mới của trường
\texttt{trainer\_type} trong tệp YAML và khởi tạo đúng lớp trainer đã đăng ký, còn mọi
phần khác của quy trình giữ nguyên. Nhờ vậy MAPPO và DQN dùng chung với ba trainer có
sẵn toàn bộ cơ chế giao tiếp gRPC với Unity, cơ chế ghi TensorBoard, cơ chế lưu điểm
kiểm tra và cơ chế xuất mô hình ONNX.

\indent MAPPO được cài đặt bằng cách kế thừa bộ tối ưu của MA-POCA và giữ lại mạng phê
bình đa tác nhân của nó, vốn nhận quan sát của cả nhóm làm đầu vào. Khác biệt nằm ở
cách tính lợi thế: MA-POCA trừ đi một đường cơ sở phản thực được ước lượng riêng cho
từng tác nhân, còn MAPPO tính lợi thế trực tiếp so với giá trị tập trung và bỏ hẳn số
hạng đường cơ sở khỏi hàm mất mát. Đây đúng là điểm khác nhau về mặt thuật toán giữa
hai phương pháp, nên cách cài đặt này bảo đảm mọi chênh lệch quan sát được giữa MAPPO
và MA-POCA đến từ cơ chế gán công lao chứ không từ kiến trúc mạng hay siêu tham số.
Cấu hình của MAPPO vì thế dùng đúng bộ siêu tham số của PPO và MA-POCA.

\indent DQN được cài đặt bằng cách kế thừa lớp trainer off-policy có sẵn, tức lớp mà
SAC đang dùng, nên nó thừa hưởng nguyên vẹn bộ đệm phát lại và lịch cập nhật theo tham
số \texttt{steps\_per\_update}. Phần viết mới là bộ tối ưu: một mạng $Q$ cùng mạng mục
tiêu cập nhật mềm, hàm mất mát sai số thời gian khác biệt và quy tắc chọn hành động
$\varepsilon$-tham lam. Ràng buộc kỹ thuật đáng kể nhất là DQN chỉ làm việc với không
gian hành động rời rạc, nên môi trường Football Table phải được dựng lại thành một bản
...
\indent Con đường còn lại vẫn được đề tài hiện thực hóa và kiểm chứng, vì nó cần thiết
cho những trường hợp phải can thiệp sâu vào chính vòng lặp huấn luyện. Thư viện
\texttt{mlagents\_envs} cho phép kết nối trực tiếp với một môi trường Unity đang chạy,
rồi bọc môi trường đó lại thành một môi trường tuân theo giao diện chuẩn thường dùng
trong cộng đồng học tăng cường; từ đó đưa được vào bất kỳ thư viện bên ngoài nào, ở đây
là Stable-Baselines3 \cite{raffin2021stable}. Quy trình gồm bốn bước: khởi chạy môi
trường Unity ở chế độ chờ kết nối, tạo đối tượng kết nối và bọc bằng lớp chuyển đổi
giao diện, khởi tạo tác nhân với kiến trúc mạng mong muốn, rồi gọi vòng lặp huấn luyện
của thư viện. Ưu điểm của cách này là giữ nguyên môi trường Unity mà không sửa mã nguồn
của nó, đồng thời trao toàn quyền kiểm soát vòng lặp huấn luyện cho thuật toán.

\indent Cần nói rõ để tránh hiểu nhầm khi đọc kết quả: mười lăm lần chạy được báo cáo ở
Chương~\ref{ch:results} đều thực hiện bằng chương trình huấn luyện của ML-Agents, kể cả
năm lần chạy SAC. Đường đi qua Stable-Baselines3 được trình bày ở đây như một phương án
đã dựng xong và dùng lại được, chứ không phải nguồn của bất kỳ con số nào trong bảng
kết quả. Đoạn mã minh họa được đặt trong Phụ lục B.
...
trình điều phối chạy tuần tự mười lăm lần huấn luyện, tự động nạp đúng tệp cấu hình cho
từng tổ hợp môi trường và thuật toán, quản lý trạng thái tiến độ, ghi nhật ký và cho
phép tiếp tục từ điểm dừng khi quá trình bị gián đoạn. Gói trainer mở rộng đã mô tả ở
mục trên cung cấp hai thuật toán MAPPO và DQN, còn lớp bọc môi trường phục vụ con đường
tích hợp qua thư viện ngoài. Cuối cùng là một
chương trình phân tích, có nhiệm vụ đọc các tệp sự kiện TensorBoard của toàn bộ mười
lăm lần chạy, trích xuất các chỉ số như phần thưởng, độ dài lượt chơi, hàm mất mát và
entropy, rồi tự động sinh ra các biểu đồ so sánh cùng một báo cáo tổng hợp. Một số
trích đoạn mã nguồn minh họa của các thành phần này được đặt trong Phụ lục E.
...
\indent Các siêu tham số chính của năm thuật toán trên từng môi trường được tóm tắt
...
năm thuật toán trên cùng một môi trường, nhằm bảo đảm sự khác biệt về kết quả phản ánh
đúng bản chất thuật toán chứ không phải do chênh lệch tham số. Cụ thể, cả năm lần chạy
trong một môi trường dùng chung tốc độ học $3\text{e}{-4}$, hệ số chiết khấu $0{,}99$
và đúng một kiến trúc mạng: hai lớp một trăm hai mươi tám đơn vị cho Cross The Road,
hai lớp hai trăm năm mươi sáu đơn vị cho Football Table và ba lớp hai trăm năm mươi sáu
đơn vị cho Capture The Flag. Những khác biệt về tham
số chỉ nằm ở các thành phần đặc thù của từng loại thuật toán, chẳng hạn kích thước bộ
đệm kinh nghiệm rất lớn của hai thuật toán off-policy hay hệ số cập nhật mềm của mạng
mục tiêu. Cấu hình đầy đủ cho từng thuật toán được liệt kê trong các Phụ lục A đến D.
...
\indent Hai thuật toán off-policy còn dùng chung tham số \texttt{steps\_per\_update}
đặt bằng hai mươi, tức mạng chỉ được cập nhật một lần sau mỗi hai mươi bước môi trường.
Giá trị này được chọn để thời gian chạy thực tế nằm trong quỹ thời gian của đề tài, và
nó có hệ quả trực tiếp lên tốc độ hội tụ đo được của SAC như phân tích ở
Chương~\ref{ch:results}.
...
Mức năng lực đạt được là phần thưởng trung bình của mười phần trăm cuối
cùng trong quá trình huấn luyện, nhằm phản ánh mức hiệu năng ổn định mà chính sách duy
trì được ở cuối quá trình thay vì một giá trị tức thời có thể rơi vào đỉnh nhiễu. Riêng
môi trường đối kháng dùng thêm chỉ số xếp hạng ELO, vì trong cơ chế tự chơi, phần thưởng
tuyệt đối không phản ánh được tiến bộ khi cả hai phía cùng mạnh lên.

\indent Tốc độ hội tụ được đo bằng bước huấn luyện đầu tiên mà từ đó
trở đi đường cong phần thưởng không còn tụt xuống dưới chín mươi phần trăm mức năng lực
ổn định cuối cùng. Cách xác định này bền vững hơn tiêu chí ``lần đầu chạm ngưỡng'' vì
không bị một đỉnh nhiễu đơn lẻ kéo về đầu chuỗi; đổi lại, một lần chạy còn dao động
mạnh ở cuối sẽ không có bước hội tụ nào, và điều đó tự nó đã là một kết quả cần báo cáo.
Độ ổn định huấn luyện được đo bằng độ lệch chuẩn của đường cong
phần thưởng trên mười phần trăm cuối; đường cong càng ít dao động thì quá
trình học càng bền vững và đáng tin cậy.

\indent Tiêu chí còn lại là độ dài trung bình của một lượt chơi. Ba
môi trường của đề tài đều kết thúc lượt chơi ngay khi nhiệm vụ hoàn thành, nên độ dài
lượt chơi đóng vai trò thay thế đo được cho tỷ lệ hoàn thành nhiệm vụ: lượt chơi chạm
trần thời gian nghĩa là tác nhân không giải xong, còn lượt chơi rút ngắn dần nghĩa là
chính sách kết thúc nhiệm vụ ngày một nhanh. Chỉ số này đặc biệt hữu ích vì nó tách được
hai kiểu kết thúc sớm mà phần thưởng đơn thuần không phân biệt nổi, giữa việc về đích
nhanh và việc thất bại sớm. Toàn bộ các chỉ số này được thu thập tự động
từ tệp sự kiện TensorBoard của mỗi lần chạy và được trực quan hóa dưới dạng biểu đồ và
bảng ở Chương~\ref{ch:results}.

\indent Về mặt dữ liệu, đề tài đánh giá một lưới đầy đủ mười lăm tổ hợp môi trường -
thuật toán, tức cả năm thuật toán PPO, SAC, MA-POCA, MAPPO và DQN trên cả ba môi trường.
Trong mỗi môi trường, năm lần chạy dùng chung một ngân sách bước đúng bằng giá trị ghi ở
Bảng~\ref{tab:env_summary}: hai triệu bước cho Cross The Road, một triệu bảy trăm nghìn
bước cho Capture The Flag và một triệu sáu trăm nghìn bước cho Football Table. Điều kiện
này là điều kiện cần để mọi so sánh có ý nghĩa, bởi chênh lệch phần thưởng giữa hai thuật
toán chỉ quy được cho bản thân thuật toán khi cả hai đã tiêu thụ cùng lượng kinh nghiệm.
Ngân sách khác nhau giữa ba môi trường không gây trở ngại, vì đề tài không so sánh chéo
giữa các môi trường mà chỉ xếp hạng trong nội bộ từng môi trường.

\indent Có đúng một ô của lưới không so sánh trực tiếp được với các ô cùng hàng: lần
chạy DQN trên Football Table. Thuật toán này đòi hỏi hành động rời rạc nên phải dùng một
bản dựng riêng của cảnh, và khi ghép thêm cơ chế tự chơi thì bộ điều phối đối kháng phát
sinh lỗi ngay khi khởi tạo, buộc lần chạy phải tắt tự chơi. Hệ quả là ô này không có chỉ
số ELO và được đọc như một tham chiếu rời. Tất cả số liệu còn lại được trích xuất trực
tiếp từ tệp sự kiện TensorBoard của mười lăm lần chạy, không qua bất kỳ bước làm mượt
nào, để bảng số liệu và đồ thị trong Chương~\ref{ch:results} luôn khớp nhau.
