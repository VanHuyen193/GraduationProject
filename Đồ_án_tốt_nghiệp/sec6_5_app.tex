...
\indent Nhóm thứ hai quy định cụ thể ba cách phân vai nói trên. Chế độ \textit{Người chơi}
cho phép người dùng tự điều khiển tác nhân bằng bàn phím, qua đó trực tiếp trải nghiệm độ
khó của nhiệm vụ mà tác nhân phải học. Chế độ \textit{Agent tự chơi} giao toàn bộ tác nhân
cho mô hình đã huấn luyện điều khiển, phục vụ việc quan sát và đánh giá trực quan chất
lượng của chính sách. Chế độ \textit{Chơi với Agent} kết hợp cả hai hình thức trên, trong
...
toán trên môi trường đang được chọn, và một tab tổng hợp, xếp hạng các thuật toán trên cả
ba môi trường. Hai tab này cần phủ đúng phạm vi thực nghiệm của Chương~\ref{ch:results},
...
\hline
\texttt{Preview3D} & Dựng bản sao của prefab môi trường và render
...
nút bắt đầu ở menu, các lựa chọn được ghi vào \texttt{GameModeSelection}, sau đó scene môi
trường tương ứng được nạp. Thành phần \texttt{GameModeApplier} đã đăng ký với sự kiện
...
\texttt{HeuristicOnly} để hành động được lấy từ hàm \texttt{Heuristic}. Đối với chế độ tác
nhân máy, loại hành vi được đặt thành \texttt{InferenceOnly}, đồng thời mô hình ONNX được
