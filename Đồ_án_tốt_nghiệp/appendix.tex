...
\smallskip
$^{\ddagger}$ Riêng DQN trên Football phải tắt self-play, do ML-Agents phát sinh lỗi khi kết hợp trainer off-policy với ghost trainer. Vì vậy lần chạy này không có chỉ số ELO và không so sánh trực tiếp được với bốn thuật toán còn lại trên cùng môi trường.
