...
(kết hợp self-play), đúng như đã dùng cho lần chạy \texttt{FB01}. Các môi trường khác
dùng cấu trúc tương tự với siêu tham số điều chỉnh theo Bảng~\ref{tab:hyperparams}.
...
\texttt{CrossTheRoad\_SAC\_01}. Tham số \texttt{steps\_per\_update} bằng hai mươi là
điểm cần chú ý nhất: nó quyết định tốc độ hội tụ đo được của SAC, như phân tích ở
