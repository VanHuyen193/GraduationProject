...
public class PuzzleAgent : Agent
{
    ...
    public override void Heuristic(in ActionBuffers actionsOut)
    {
        ...
        // Nguồn điều khiển thủ công do ứng dụng nhúng gắn vào. Hai tác nhân dùng
        // hai thành phần riêng nên hai người chơi điều khiển được trên cùng bàn
        // phím. Xem VanHuyen.RLGameEnvs.IManualActionSource.
